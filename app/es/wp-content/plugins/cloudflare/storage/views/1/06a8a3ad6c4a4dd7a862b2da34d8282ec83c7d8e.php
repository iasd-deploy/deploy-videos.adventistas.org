...
<?php else: ?>
						...
						<div class="row">
							...
							<div class="col">
								<div class="card-body p-0">
									<h3 class="card-title h6 fw-bold pa-truncate-3"><?php echo wp_strip_all_tags(get_the_title($id)); ?></h3>
								</div>
							</div>
						</div>
					</a>
	...
	<?php endif; ?>
<?php endif; ?>
<?php /**PATH /Users/isaltino/Git/deploy-videos.adventistas.org/app/es/wp-content/themes/pa-theme-videos/Blocks/PAListVideosColumn/views/frontend.blade.php ENDPATH**/ ?>