<?php if(is_admin()): ?>
	<img class="img-preview" src="<?php echo e(get_template_directory_uri()); ?>/Blocks/PACarouselFeature/preview.png" />
<?php else: ?>
							...
							<?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<div class="glide__slide position-relative">
									...
									<?php if (! empty($item['title'])) : ?>
										<h3 class="card-title fw-bold h5 mt-4 pa-truncate-1"><?php echo $item['title']['rendered']; ?></h3>
									<?php endif; ?>

									<?php if (! empty($item['excerpt'])) : ?>
										<p class="card-text pa-truncate-2"><?php echo e(wp_strip_all_tags($item['excerpt']['rendered'])); ?></p>
									<?php endif; ?>
									...
									<?php if (! empty($item['link'])) : ?>
										...
										>
											<span class="visually-hidden"><?php echo $item['title'] ?: 'Link do slide' . $loop->iteration; ?></span>
										</a>
									<?php endif; ?>
								</div>
...
<?php endif; ?><?php /**PATH /Users/eli/Dropbox (ComunicaDSA)/projects/videos.adventistas.org-old/pt/wp-content/themes/pa-theme-sedes/Blocks/PACarouselFeature/views/frontend.blade.php ENDPATH**/ ?>