<?php if(is_admin()): ?>
	<img class="img-preview" src="<?php echo e(get_stylesheet_directory_uri()); ?>/Blocks/PAListVideosColumn/preview.png" alt="<?php echo e(__('Illustrative image of the front end of the block.', 'iasd')); ?>"/>
<?php else: ?>
	<?php if (! empty($items)) : ?> 
						...
						<div class="row">
							<div class="img-container">
								<div class="ratio ratio-16x9">
									<figure class="figure m-xl-0">
										<img src="<?php echo e(check_immg($id, 'full')); ?>" class="figure-img img-fluid rounded m-0" alt="<?php echo wp_strip_all_tags(get_the_title($id)); ?>">
							...
							<div class="col">
								<div class="card-body p-0">
									<h3 class="card-title h6 pa-truncate-3"><?php echo wp_strip_all_tags(get_the_title($id)); ?></h3>
								</div>
							</div>
						</div>
					</a>
	...
	<?php endif; ?>
<?php endif; ?><?php /**PATH /Users/eli/Dropbox (ComunicaDSA)/projects/deploy-videos.adventistas.org/app/pt/wp-content/themes/pa-theme-videos/Blocks/PAListVideosColumn/views/frontend.blade.php ENDPATH**/ ?>