<?php if(is_admin()): ?>
    <img class="img-preview" src="<?php echo e(get_template_directory_uri()); ?>/Blocks/PAFeliz7Play/preview.png" />
<?php else: ?> 
	<div class="pa-widget pa-w-feliz7play py-4 col-12 position-relative bg-light mb-5">
		<div class="pa-slider-header mb-4">
			<div class="d-flex justify-content-between align-items-center">
				<img src="<?php echo e(get_template_directory_uri()); ?>/Blocks/PAFeliz7Play/assets/images/f7p-logo.svg" alt="Feliz7Play" title="Feliz7Play" class="img-fluid">
...
<?php endif; ?>
<?php /**PATH /Users/eli/Dropbox (ComunicaDSA)/projects/videos.adventistas.org-old/pt/wp-content/themes/pa-theme-sedes/Blocks/PAFeliz7Play/views/frontend.blade.php ENDPATH**/ ?>