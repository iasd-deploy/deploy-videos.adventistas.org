...
class Log_memory extends Log
{
     ...
     * @access public
     */
    function Log_memory($name, $ident = '', $conf = array(),
                         $level = PEAR_LOG_DEBUG)
    {
        ...
        if (!empty($conf['stream'])) {
            ...
            $this->_stream = fopen('php://memory', 'a');
    ...
    function flush()
    {
        ...
        if (is_resource($this->_stream)) {
            fflush($this->_stream);
            rewind($this->_stream);
            $log_string = stream_get_contents($this->_stream);
